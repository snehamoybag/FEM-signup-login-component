...
// Doing input validation while user types
inptFirstNameEl.addEventListener("input", () => { inputValidator(inptFirstNameEl, "First Name", regex.name, 2, 60) });
inptLastNameEl.addEventListener("input", () => { inputValidator(inptLastNameEl, "Last Name", regex.name, 2, 60) });
inptEmailEl.addEventListener("input", () => { inputValidator(inptEmailEl, "Email", regex.email, 3, 320) });
inptPasswordEl.addEventListener("input", () => { inputValidator(inptPasswordEl, "Password", regex.password, 8, 48) });
